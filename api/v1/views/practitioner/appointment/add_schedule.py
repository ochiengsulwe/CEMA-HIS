...
@practitioner.route('/appointment/<appointment_id>/add-schedule', methods=['POST'])
@swag_from('/api/v1/views/practitioner/documentation/appointment/add_schedule.yml')
@jwt_required()
def schedule_add(appointment_id):
