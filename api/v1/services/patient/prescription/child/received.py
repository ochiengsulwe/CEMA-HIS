...
def received_prescriptions(child_id):
    """
    Retrieves all 'received' prescriptions for a child patient, grouped by
    prescription date.

    Only retrieves prescriptions that have been received.
    Args:
    ...
    try:
        ...
        for appointment in child.appointments:
            for schedule in appointment.schedules:
                ...
                if prescription and prescription.status == 'received':
                    practitioner = (
