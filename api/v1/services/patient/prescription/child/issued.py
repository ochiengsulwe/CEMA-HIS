...
def issued_prescriptions(child_id):
    """
    Retrieves all 'issued' prescriptions for a child patient, grouped by
    prescription date.

    Only retrieves prescriptions that have been issued.
    ...
    try:
        ...
        for appointment in child.appointments:
            for schedule in appointment.schedules:
                ...
                if prescription and prescription.status == 'issued':
                    practitioner = (
