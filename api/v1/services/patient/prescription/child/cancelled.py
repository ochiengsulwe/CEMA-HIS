...
def cancelled_prescriptions(child_id):
    """
    Retrieves all 'cancelled' prescriptions for a child patient, grouped by
    prescription date.

    Only retrieves prescriptions that have been cancelled.
    ...
    try:
        ...
        for appointment in child.appointments:
            for schedule in appointment.schedules:
                ...
                if prescription and prescription.status == 'cancelled':
                    practitioner = (
