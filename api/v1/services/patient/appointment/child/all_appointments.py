"""
This module defines how all appointments will be retrieved for dependents only.
...
def all_appointments(child_id):
    """
        Retrieves all appointments for a child via an authenticated parent's account.
    ...
    try:
        ...
        schedules = Schedule.query.filter(
            Schedule.appointment_id.in_([a.id for a in appointments])).all()
