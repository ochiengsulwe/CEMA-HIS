...
def list_enrolled_programs(child_id):
    """
    Lists all health programs a child patient is enrolled in,
    ...
    try:
        ...
        for practitioner_program in child.enrolled_programs:
            ...
            appointments = [
                app for app in child.appointments
