"""
This module defines how all completed appointments will be retrieved for practitioners
"""
...
def completed_appointments():
    """
        Retrieves all completed appointments for the authenticated practitioner.
