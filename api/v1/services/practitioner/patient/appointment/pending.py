"""
This module defines how all pending patient appointments relating to the
...
def pending_appointments(loginfo_id):
    """
        Retrieves all related patient pending appointments for the authenticated
            practitioner.
