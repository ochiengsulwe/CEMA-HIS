"""
This module defines how all patient appointments relating to the practitioner will
    be retrieved
They will include both complete and ongoing appointments
"""
...
def all_appointments(loginfo_id):
    """
        Retrieves all related patient appointments for the authenticated practitioner.
    ...
    try:
        ...
        schedules = Schedule.query.filter(
            Schedule.appointment_id.in_((a.id for a in appts))).all()
        if not schedules:
